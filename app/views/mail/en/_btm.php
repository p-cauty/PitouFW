...
<div  style="color: #636c72;font-size: 11px;" align="center">
    You are receiving this e-mail because you own a <a
            href="<?= APP_URL ?>"><?= NAME ?></a> account
...
<div  style="color: #636c72;font-size: 11px;" align="center">
    <a href="<?= APP_URL ?>api/mailer/<?= $browser_id ?>?render_key=<?= $browser_key ?>">
        See this e-mail in your browser
    </a>
</div>
<div  style="color: #636c72;font-size: 11px;" align="center">
    <a href="<?= APP_URL ?>user/unsubscribe?email=<?= $unsubscribe_email ?>&key=<?= $unsubscribe_key ?>">
        Unsubscribe</a>
</div>
<table  border="0" cellpadding="0" cellspacing="0"
       style="width: 100%;">
